...
export function gscPriorityUrls(): string[] {
  ...
  return [
    ...
    `${SITE}/faq`,
    `${SITE}/a-propos`,
    `${SITE}/guide/trouver-vendeur-sac-luxe`,
    `${SITE}/guide/budget-sac-luxe`,
    `${SITE}/guide/identifier-modele-sac`,
    `${SITE}/guide/comparer-offres-vendeurs`,
    `${SITE}/guide/eviter-arnaques-vendeurs`,
    `${SITE}/guide/eu/fr`,
    `${SITE}/guide/eu/de`,
    `${SITE}/guide/eu/en`,
    ...p0Slugs.map((s) => `${SITE}/guide/${s}`),
    `${SITE}/sacs/louis-vuitton/neverfull`,
    `${SITE}/sacs/hermes/birkin`,
    ...
    `${SITE}/articles/hermes-birkin-touch`,
  ];
}
