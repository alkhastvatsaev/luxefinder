...
const SEO_PAGES_CORE: SeoPage[] = [
  ...
  },
  {
    ...
    h1: "Votre première recherche sur LuxeFinder",
    description:
      "Photo, budget, lecture des résultats : le parcours idéal pour un premier essai.",
    intent: "howto",
    intro:
      "Un premier essai réussi conditionne la confiance. Suivez un ordre simple : photo nette → budget → lecture des offres → vérification.",
    sections: [
      {
        h2: "Préparer la photo",
        body: "Fond neutre, bonne lumière, objet centré. Une seule pièce par photo si possible.",
      },
      {
        h2: "Lancer la recherche",
        body: "Sur luxefinder.app, déposez la photo et indiquez votre budget. Lisez la description proposée avant de contacter.",
      },
      {
        h2: "Ensuite",
        body: "Comparez, posez des questions écrites, ne payez qu’avec des preuves. Revenez aux guides LuxeFinder si un point bloque.",
      },
    ],
    related: ["premiere-recherche", "trouver-vendeur-sac-luxe", "comparer-offres-vendeurs"],
  },
  {
    slug: "authentifier-sac-luxe",
    title: "Points clés pour authentifier un sac de luxe",
    h1: "Authentifier un sac de luxe : points de contrôle",
    description:
      "Coutures, hardware, marquage, symétrie : checklist d’observation avant d’acheter via un vendeur.",
    intent: "howto",
    intro:
      "Aucune checklist en ligne ne remplace un expert, mais elle évite les erreurs grossières et structure vos questions au vendeur.",
    sections: [
      {
        h2: "Ce qu’il faut regarder",
        body: "Alignement des motifs, qualité des coutures, gravure du hardware, odeur/texture du matériau (sur place), symétrie des poignées.",
      },
      {
        h2: "Demander des preuves",
        body: "Photos macro, date, même lot. Méfiez-vous des photos catalogue uniquement.",
      },
      {
        h2: "Lien avec LuxeFinder",
        body: "Une fois le modèle identifié via photo, utilisez ces points pour challenger chaque offre remontée.",
      },
    ],
    related: ["photos-qc-lire", "qc-checklist", "eviter-arnaques-vendeurs"],
  },
  ...
  },
  {
    ...
    description:
      "Points à contrôler sur les photos QC : coutures, hardware, logo, symétrie — guide LuxeFinder.",
    intent: "howto",
    intro:
  ...
  },
  {
    ...
    description:
      "Poids, split de colis, QC groupé, budget shipping — guide haul France LuxeFinder.",
    intent: "howto",
    intro:
  ...
  },
  {
    ...
    description:
      "Pourquoi un canal discret aide : alertes QC, guides, questions — LuxeFinder.",
    intent: "howto",
    intro:
    ...
    sections: [
      {
        h2: "À quoi ça sert",
        body: "Mises à jour de guides, rappels checklist, réponses aux questions fréquentes, et orientation vers les bonnes pages LuxeFinder.",
      },
      {
  ...
  {
    slug: "cartier",
    title: "Guide Cartier — LuxeFinder",
  ...
  {
    slug: "saint-laurent",
    title: "Guide Saint Laurent — LuxeFinder",
  ...
  {
    slug: "bottega-veneta",
    title: "Guide Bottega Veneta — LuxeFinder",
  ...
  {
    slug: "van-cleef",
    title: "Guide Van Cleef — LuxeFinder",
  ...
  // ── Batch 4: Intention d'achat (lexical réplique / marques) ───────
  {
    ...
    description:
      "Acheter Louis Vuitton réplique : Yupoo, WhatsApp vendeur, agent, QC et livraison France. Guide LuxeFinder.",
    intent: "buy",
    brands: ["louis_vuitton"],
    intro:
  ...
  },
  {
    ...
    brands: ["hermes"],
    intro:
      "Acheter une réplique Hermès demande plus de rigueur QC que la moyenne : cuir, ferroir, couture. Voici le parcours utilisé en France.",
    sections: [
      {
      ...
      },
      {
        ...
        body: "Agent pour sécuriser le paiement, ou direct WA si vous assumez le risque. Essayez LuxeFinder pour un cadrage discret.",
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Aide",
        body: "Guides pratiques LuxeFinder + contact Telegram si vous voulez valider un vendeur avant de payer.",
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "France",
        body: "Anticipez douane / shipping. LuxeFinder pour le parcours pas à pas.",
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Paiement",
        body: "Preuves écrites, montants raisonnables. LuxeFinder si besoin d’un second regard.",
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "France",
        body: "Agent + tracking. Contact discret via LuxeFinder.",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Acheter Fendi réplique : Baguette, Peekaboo, QC motif FF. Guide LuxeFinder.",
    intent: "buy",
    brands: ["fendi"],
    intro:
    ...
    sections: [
      ...
      {
        h2: "Suite",
        body: "LuxeFinder + guides pratiques livraison / douane.",
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Contact",
        body: "LuxeFinder pour valider le prochain pas.",
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Aide",
        body: "Essayez LuxeFinder avant de payer un vendeur inconnu.",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Meilleur site réplique France : Yupoo n’est pas une boutique. Agents, vendeurs WA, QC — guide LuxeFinder.",
    intent: "buy",
    intro:
    ...
    sections: [
      ...
      {
        h2: "Stack recommandé",
        body: "Yupoo (vitrine) + agent actuel + ligne shipping France. LuxeFinder centralise les guides pour ne pas naviguer à l’aveugle.",
      },
      {
        h2: "Passer à l’action",
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Contact",
        body: "LuxeFinder pour cadrer un premier achat sans précipitation.",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Réplique sac luxe qualité : checklist QC, vendeurs Yupoo, agent France. Guide LuxeFinder.",
    intent: "buy",
    intro:
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Contact",
        body: "Telegram ou formulaire LuxeFinder.",
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Aide",
        body: "Guides douane + shipping LuxeFinder. Contact si votre colis stagne.",
      },
    ],
  ...
  },
  {
    ...
    brands: ["hermes"],
    intro:
      "« Copie Hermès Birkin » et « réplique Birkin » sont le même intent d’achat. Le succès dépend du QC, pas du mot utilisé.",
    sections: [
      {
...
export function pagesByIntent(intent: SeoPage["intent"]): SeoPage[] {
...
/** @deprecated use SEO_PAGES / getPage — kept for any leftover imports */
